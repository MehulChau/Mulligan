 ...
 *
 * The reusable simulation/analysis engine lives in tools/lib/playtestEngine.ts
 * (shared with tools/course-playtest.ts, Part B's per-hole verification).
 */
import { CLUBS } from "@mulligan/shot-source";
import { HOLE_1 } from "@mulligan/game";
import { writeFileSync } from "node:fs";
import { resolve } from "node:path";
import {
  ROUNDS_PER_CONFIG,
  LAYUP_SAFETY_MARGIN_YDS,
  analyzeClubUsage,
  fmtPct,
